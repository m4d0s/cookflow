...
class _ShopListWidgetState extends State<ShopListWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: FFAppState().BuySelect.name);
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  'Рецептный список: ${FFAppState().BuyList.where((e) => (e.productId != -1) && e.bought).toList().length.toString()}/${FFAppState().BuyList.where((e) => e.productId != -1).toList().length.toString()}',
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title: Text(
                                                              'У вас нету рецептов'),
                                                          content: Text(
                                                              'Прежде, чем добавлять продукты из рецептов , сначала создайте их в главном меню по кнопке \"Создать рецепт\"'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                'ID структуры: ${FFAppState().BuySelect.id.toString()} | ID рецепта: ${FFAppState().BuySelect.productId.toString()}',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(

...
class _ProductBaseWidgetState extends State<ProductBaseWidget> {
  ...
  void initState() {
    ...
    _model.textController2 ??=
        TextEditingController(text: FFAppState().ProductSelect.name);
    ...
    _model.textController4 ??= TextEditingController(
        text: formatNumber(
      FFAppState().ProductSelect.nutrition100g.protein,
      formatType: FormatType.custom,
      format: '0.##',
      locale: '',
    ));
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: Visibility(
          visible: !FFAppState().BaseNewItem,
                            ...
                            children: List.generate(productable.length,
                              ...
                              return wrapWithModel(
                                ...
                                child: ProductItemWidget(
                                  key: Key(
                                    'Keycve_${productableIndex.toString()}',
                                  ),
                                  showEdit: true,
                                    ...
                                    children: [
                                        ...
                                        child: Padding(
                                          ...
                                          child: Stack(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                'Продукт ${FFAppState().ProductSelect.nutrition100g.calories > 0.0 ? formatNumber(
                                                    FFAppState()
                                                        .ProductSelect
                                                        .nutrition100g
                                                        .calories,
                                                                  ...
                                                                  (e) => e
                                                                    ...
                                                                    ..carbs = double
                                                                        .tryParse(_model
                                                                            .textController6
                                                                            .text)
                                                                    ..calories = double.parse(_model.textController4.text) * 4 +
                                                            ...
                                                            onFieldSubmitted:
                                                              ...
                                                              FFAppState()
                                                                ...
                                                                (e) => e
                                                                  ...
                                                                  ..updateNutrition100g(
                                                                    (e) => e
                                                                      ..protein = double.tryParse(_model
                                                                          .textController4
                                                                          .text)
                                                                      ..fats = double.tryParse(_model
                                                                          .textController5
                                                                          .text)
                                      ...
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            0.0, 8.0, 0.0, 0.0),
                                        child: Text(
                                          'ID структуры: ${FFAppState().ProductSelect.id.toString()}',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.inter(

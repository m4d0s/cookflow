        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            if (dateTimeFormat("yMd", getCurrentTimestamp) ==
                dateTimeFormat(
                    "yMd", FFAppState().AllDailyPlans.lastOrNull?.date)) {
              FFAppState().addToAllDailyPlans(DailyPlanStruct(
                date: functions
            ...
            context.pushNamed(RecipeChooseWidget.routeName);
          },
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      LinearPercentIndicator(
                                        ...
                                        height: FFAppConstants.Padding0
                                            .toDouble())),
                                  ),
                                  Container(
                                    width: 1.0,

...
export 'recipe_edit_model.dart';

class RecipeEditWidget extends StatefulWidget {
  const RecipeEditWidget({super.key});

  static String routeName = 'RecipeEdit';
  static String routePath = 'recipeEdit';
                ...
                var confirmDialogResponse = await showDialog<bool>(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          ...
                          content: Text(
                              'Вы уверены, что хотите выйти? Рецепт не изменится'),
                          actions: [
                            TextButton(
                              onPressed: () =>
                ...
                var confirmDialogResponse = await showDialog<bool>(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          title: Text('Подтверждение'),
                          content: Text(
                              'Вы уверены, что хотите выйти? Рецепт не создастся'),
                          actions: [
                            TextButton(
                              onPressed: () =>
                                  Navigator.pop(alertDialogContext, false),
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          FFAppState().updateRecipeSelectStruct(
                            (e) => e..pictureBase64 = _model.recipePhotoBase64,
                          );
                          safeSetState(() {});
                                ...
                                child: Container(
                                  ...
                                  child: FlutterFlowCountController(
                                    ...
                                    count: _model.countControllerValue2 ??=
                                        FFAppState().RecipeSelect.cookTime,
                                    updateCount: (count) async {
                                      safeSetState(() =>
                ...
                Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              ...
                              context.pushNamed(ProductSelectWidget.routeName);
                            },
                            child: Container(
                              decoration: BoxDecoration(
                                color: FlutterFlowTheme.of(context)
                    ...
                    Builder(
                      builder: (context) {
                        final productList =
                            FFAppState().RecipeSelect.products.toList();
                        ...
                        return Column(
                          ...
                          children: List.generate(productList.length,
                            ...
                            return wrapWithModel(
                              model: _model.ingridientEditModels.getModel(
                                productListIndex.toString(),
                                productListIndex,
                              ),
                              updateCallback: () => safeSetState(() {}),
                              child: IngridientEditWidget(
                                key: Key(
                                  'Keyk82_${productListIndex.toString()}',
                                ),
                    ...
                    Builder(
                      builder: (context) {
                        final stepList = FFAppState()
                            .RecipeSelect
                            .cookingSteps
                            .sortedList(keyOf: (e) => e.queueId, desc: false)
                            .toList();
                        ...
                        return Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children:
                              List.generate(stepList.length, (stepListIndex) {
                            final stepListItem = stepList[stepListIndex];
                            return wrapWithModel(
                              model: _model.stepEditModels.getModel(
                                stepListItem.queueId.toString(),
                                stepListIndex,
                              ),
                              updateCallback: () => safeSetState(() {}),
                              child: StepEditWidget(
                                key: Key(
                                  'Key0ew_${stepListItem.queueId.toString()}',
                                ),
                                step: stepListItem,
                              ),
                            );

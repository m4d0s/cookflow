...
import 'shop_create_model.dart';
export 'shop_create_model.dart';

class ShopCreateWidget extends StatefulWidget {
  const ShopCreateWidget({
    super.key,
    required this.item,
  });
  ...
  @override
  State<ShopCreateWidget> createState() => _ShopCreateWidgetState();
}

class _ShopCreateWidgetState extends State<ShopCreateWidget> {
  late ShopCreateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShopCreateModel());
